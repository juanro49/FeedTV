...
public class TvActivity extends AppCompatActivity implements JSONParser.ResponseServerCallback
{
	 ...
	 */
	private final Runnable cargarDatos = new Runnable()
	{
		@Override
		public void run()
		{
			JSONParser.getInstance().loadChannels(true, TvActivity.this, TvActivity.this);
		}
	};

	/**
	 * Crear la lista con los canales obtenidos
	 *
	 * @param canales
	 */
	@Override
	public void onChannelsLoadServer(ArrayList<Canal> canales)
	{
		mAdapter = new ChannelsAdapter(getApplicationContext(), canales);
